...
function tdpersona_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav"><i class="fa fa-angle-double-left"></i></span> 从前', 'tdpersona' ) ); ?></div>
		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( __( '之后 <span class="meta-nav"><i class="fa fa-angle-double-right"></i></span>', 'tdpersona' ) ); ?></div>
		<?php endif; ?>
...
function tdpersona_posted_on() {
	...
	if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) {
		ob_start();
		$comments_link = comments_popup_link( __( '评论两句', 'tdpersona' ), __( '1条评论', 'tdpersona' ), __( '%条评论', 'tdpersona' ) );
